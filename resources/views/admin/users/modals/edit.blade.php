                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="invalid-feedback d-block" style="display: none;">La contraseña debe cumplir con los requisitos</div>
                        ...
                        <div class="col-md-6">
                            ...
                            <small class="text-muted d-block text-center mt-2">Arrastra tu imagen o haz click. Máx: 2MB</small>
    ...
    if (editUserModal) {
        editUserModal.addEventListener('hidden.bs.modal', function() {
            ...
            if (form) {
                ...
                document.querySelectorAll('#editPasswordRequirements .requirement').forEach(req => req.classList.remove('valid'));

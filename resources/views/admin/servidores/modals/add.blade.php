                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="nombre"
                                placeholder="Ej. Servidor Web Principal" required maxlength="150">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="btn-group w-100">
                                <input type="radio" class="btn-check" name="tipo_servidor" id="tipo-fisico"
                                    value="físico" {{ old('tipo_servidor', 'físico') == 'físico' ? 'checked' : '' }}>
                                ...
                                <input type="radio" class="btn-check" name="tipo_servidor" id="tipo-virtual"
                                    value="virtual" {{ old('tipo_servidor') == 'virtual' ? 'checked' : '' }}>
